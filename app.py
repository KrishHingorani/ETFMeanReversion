...
def main():
    ...
    objective = st.sidebar.selectbox(
        "Optimization Objective",
        ["equal_weighted", "sharpe", "minimum_variance", "drawdown", "risk_adjusted_drawdown"],
    ...
    # Note: Risk-free rate removed for simplicity
    ...
    if optimize_button and ticker_input:
            ...
            try:
                    ...
                    if 'factor_insights' in factor_etf_results:
                        ...
                        if insights['dominant_factors']:
                            ...
                            for factor in insights['dominant_factors']:
                                direction_color = "🟢" if factor['direction'] == "Overweight" else "🔴"
                                st.write(f"{direction_color} **{factor['factor']}**: {factor['direction']} "
                ...
                if not factor_etf_results and pca_results:
                    ...
                    if total_explained > 0.95:
                        st.warning("⚠️ **High Concentration Risk:** Your portfolio is dominated by a few factors. Consider diversifying across more asset classes or sectors.")
                        ...
                        st.info("ℹ️ **Moderate Concentration:** Your portfolio has reasonable diversification but could benefit from some optimization.")
        ...
        **How to use:**
        ...
        3. Select the data period for analysis
        4. Click "Optimize Portfolio"
        5. Review results, factsheet, and IV analysis
        6. Export if needed
